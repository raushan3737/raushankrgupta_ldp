...
public class MyDemoLoggingAspect {
    ...
    public Object aroundGetFortune(
        ...
        try {
            ...
            // Log the exception
            log.warn("Failed to run the method: " + e.getMessage());

            /*
            // Handling the exception so, that main app will never know about the exception occurred.
            ...
            log.error("Rethrowing the exception to the caller: ");
            throw e;
        }
